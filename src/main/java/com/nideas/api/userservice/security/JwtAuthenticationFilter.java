  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      if (StringUtils.hasText(jwt) && tokenProvider.validateToken(jwt)) {
        //        Pair<UserRole, Long> userRoleId = tokenProvider.getUserIdFromJWT(jwt);
        JwtPayLoad jwtPayLoad = tokenProvider.extractJwtPayLoad(jwt);
        ...
        */
        UserDetails userDetails =
            customUserDetailsService.loadUserById(jwtPayLoad.getUserRole(), jwtPayLoad.getId());
